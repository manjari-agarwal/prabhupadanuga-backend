...
import { sendOtp, confirmOtp, register } from '../controllers/auth.controller.js';
...
router.post('/otp/verify', validate(z.object({ destination: z.string().min(3), channel: z.enum(['mobile', 'email']), otp: z.string().regex(/^\d{6}$/) }), confirmOtp));
